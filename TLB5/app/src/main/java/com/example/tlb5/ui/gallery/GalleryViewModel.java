...
import com.example.tlb5.DetailGalleryActivity;
import com.example.tlb5.R;
import com.example.tlb5.Rest;

import java.util.List;

public class GalleryViewModel extends RecyclerView.Adapter<GalleryViewModel.MyViewHolder>  {

    static Context mContext;
    List<Rest> mData;

    public GalleryViewModel(Context mContext, List<Rest> mData){
