...
public class RecyclerHotelViewAdapter extends RecyclerView.Adapter<RecyclerHotelViewAdapter.MyViewHolder> {
    static Context mContext;
    List<Hotel> mData;

    public RecyclerHotelViewAdapter(Context mContext, List<Hotel> mData){
